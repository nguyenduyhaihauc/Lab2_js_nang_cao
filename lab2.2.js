// CODING  CHANLLENGE #4
// Viết 1 chương trình nhận vào 1 danh sách các biến được viết theo kiểu  underscore (ví dụ: ten_bien) và chuyển nó sang dạng camelCase (ví dụ: tenBien) Đầu vào sẽ đến từ một vùng văn bản được chèn vào DOM (xem mã bên dưới) và  chuyển đổi sẽ xảy ra khi nhấn nút. 
...
// calculate_AGE 
// delayed_departure 
// - Đầu ra mong muốn (Hãy log các kết quả này ra màn hình để đối chiếu với  kết quả phía dưới) 
// underscoreCase   ✅ 
// firstName        ✅✅ 
// someVariable     ✅✅✅ 
// calculateAge     ✅✅✅✅ 
